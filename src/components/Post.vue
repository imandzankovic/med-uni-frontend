<template>
<body>
    <header class="masthead" :style="{'background-image': 'url(' + require('./assets/img/01-when-alternative-medicine-goes-wrong-doctor.jpg') + ')'}">
    ...
    <article>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10 col-lg-8 col-xl-9 offset-md-1 mx-auto" style="width: 555px;margin: -2px;margin-top: -11px;margin-left: 89px;">
                    ...
                    <blockquote
                        ...
                        <p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank to the size of a marble, the most beautiful you can imagine. That beautiful, warm, living object looked so fragile, so delicate, that if you
                            touched it with a finger it would crumble and fall apart. Seeing this has to change a man.</p><iframe allowfullscreen="" frameborder="0" width="560" height="315" src="https://www.youtube.com/embed/tgbNymZ7vqY" style="width: 572px;height: 389px;margin: 120px 120px;"></iframe>
                        <a
                            href="#"></a><span class="caption text-muted">To go places and do things that have never been done before – that’s what living is all about.</span>
